      ...
      <div className="item">
        ...
        <div className=" middle aligned content">
          <div className="header">
            <h3>
              My name is Josh and I'm a web developer located in Portland, Oregon. I've been programming and
              developing web apps since 2018 using a variety of languages and frameworks. I'm passionate and
              enthusiastic about developing intuitive interfaces that facilitate a superior user experience as
              well as creating applications and web services to help others learn.{" "}
              <div>
