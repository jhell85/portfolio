    ...
    <Container className="padded-container">
      ...
      <div className="ui items">
        <div className="item item-pt">
          <div
            className={`
          ${isMobile ? "padding-bottom ui small experience-img" : "ui medium rounded image"}`}>
            <CodeGuildSvg />
          </div>
        ...
        <div className="item item-pt">
          <div className="ui medium rounded image rpc">
            <img
        ...
        <div className="item item-pt">
          <div className="ui medium rounded image theorem">
            <img
              src={
